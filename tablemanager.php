...
function block_superframe_display_in_table($data){
    ...
    // Create the html table: you won't need to change this code.
...
$tablename = "user";
$fieldname = "firstname";  // This should match the name in the form definition
$fieldlist =   'id, firstname, lastname, city';  // Used to select which fields to return.
...
{
    $alldata = $DB->get_records($tablename, null, null, $fieldlist);
}
